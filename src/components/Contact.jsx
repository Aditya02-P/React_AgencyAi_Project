...
const Contact = () => {
    return (
        <div id='contact' className='relative flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            ...
            <form action="" className='grid sm:grid-cols-2 gap-2 sm:gap-5 max-w-2xl w-full '>
                <div className=''>
                  ...
                  <div className=''>
                    ...
                    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                        ...
                        <input type="email" placeholder='Enter Your Mail...' className='w-full p-3 text-sm outline-none' />
                    </div>
                </div>
